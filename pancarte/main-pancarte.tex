...
\begin{columns}
 ...
 {\centering \includegraphics[width=30cm,height=8cm]{figures/rotation-example.png}}
  ...
  \midrule
  \multirow{2}{*}{9-classes} & U-Net & 50 & Dice & 0.8263 & 0.8393 \\
  & VGG16 & 20 & Dice & 0.8387 & \colorbold{0.8023} \\
  \midrule
  ...
  Here is sample that shows our best results for 9-classes VGG16 model on test set images:
  
  \vspace{2mm}
  
  \begin{center}
  	\includegraphics[width=25cm,height=16.2cm]{figures/test-9-class.png}
  \end{center}
  ...
  \textbf{Discussion:}
    ...
    \begin{itemize}
        \item For 9-classes model, we need more images.
        \item A pre-trained model is a must with that few images. The model also seems to need a long a slow learning.
    ...
    \begin{itemize}
        ...
        \item Build a proper decoder more specific to the task.
